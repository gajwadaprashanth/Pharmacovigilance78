...
<div class = "col-lg-10" style = "float:right;">
  <form action="heading.php" method = "POST" >
    ...
    <button type="submit" class="btn  btn-success"  style = "margin-bottom:30px;" name="create_new_record">Add Headings</button>
     

     
    <button type="submit" class="btn btn-danger"  style = "margin-bottom:30px;" name="download">Download</button>
    
     
     
    <button type="submit" class="btn btn-primary"  style = "margin-bottom:30px;" name="upload_file">Version Control</button>
 ...
 <div class="container">
           <div class="row text-center " >
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
						 <h3 style="margin-bottom:20px;">Index Page</h3>
			...
			?>
							 ...
							 <?php if($sr%2==0){ ?> 
                            <a  href="subindex.php?name=<?php echo $name;?>&table=<?php echo $table; ?>&sr=<?php echo $sr;?>" class="btn btn-info btn-ll" >
                               <?php echo $sr.'.'.$name;?> 
                             </a>
                           
                             <a href="headingedit.php?id=<?php echo $postid;?>"> <img src="ee.png" height="25"></a>                                                          
							 <a href="headingdelete.php?id=<?php echo $postid;?>"><img src="dd.png"  height="25"></i></a>
                            <?php }
                             else{
							 ?> 
                            <a  href="subindex.php?name=<?php echo $name;?>&table=<?php echo $table; ?>&sr=<?php echo $sr;?>" class="btn btn-success btn-ll" >
                               <?php echo $sr.'.'.$name;?>
                            </a>
